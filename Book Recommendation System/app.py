...
st.markdown("""
    ...
    .stTabs [data-baseweb="tab"]:hover {
        background-color: #B20710;  /* darker hover red */
        color: white;
        border-radius: 10px;
    }
    </style>
...
with tab1:
    st.markdown(f"<h1 style='color:{button_color}; text-align:center;'>Most Popular Books</h1>", unsafe_allow_html=True)
    st.markdown(f"""
        <style>
        .book-card {{
...
with tab2:
    st.markdown(f"<h1 style='color:{button_color}; text-align:center;'>Find Similar Books</h1>", unsafe_allow_html=True)
                ...
                with col:
                    st.markdown(
                        ...
                        <div style='
                            ...
                            <em style='color:#E50914; font-weight:bold;'>{author}</em><br>
